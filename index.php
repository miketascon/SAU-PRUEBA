...
<!-- ### MENU ### -->
    ...
    <!-- panel -->
    <div class="panel panel-default">
      <div class="panel-heading"><i class="fa fa-pencil"></i> Publicaciones </div>
      <div class="panel-body">
        
        <!-- status form -->
         <form method="POST" action="includes/publicaciones.php">
           <textarea name="estatus" class="form-control"></textarea>
           <p></p>
